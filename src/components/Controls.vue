<template>
  <div v-if="game.paused.value !== true && smolScreen()"
    ...
    <div class="border border-3 rounded-lg border-yellow-400 z-20 font-share text-yellow-400" @pointerdown="goLeft()"
    ...
    <div class="border border-3 rounded-lg border-yellow-400 z-20 font-share text-yellow-400" @pointerdown="goRight()"
      @pointerup="game.resetMovement()">
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
        class="w-12 h-12">
