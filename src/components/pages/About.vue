<template>
    <div class="px-6 py-32 lg:px-8">
            ...
            <div class="mt-10 max-w-2xl">
                ...
                <ul role="list" class="mt-8 max-w-xl space-y-8">
                    <li class="flex gap-x-3">
                        <span><strong class="font-semibold text-white font-share">Data types.</strong> Lorem ipsum, dolor sit amet
                            consectetur adipisicing elit. Maiores impedit perferendis suscipit eaque, iste dolor cupiditate
                            blanditiis ratione.</span>
                    </li>
                    <li class="flex gap-x-3">
                        <span><strong class="font-semibold text-white font-share">Loops.</strong> Anim aute id magna aliqua ad ad
                            non deserunt sunt. Qui irure qui lorem cupidatat commodo.</span>
                    </li>
                    <li class="flex gap-x-3">
                        <span><strong class="font-semibold text-white font-share">Events.</strong> Ac tincidunt sapien vehicula erat
                ...
                <h2 class="mt-16 text-2xl font-bold tracking-tight text-white font-share">From beginner to expert in 3 hours</h2>
                ...
                <figure class="mt-10 border-l border-indigo-600 pl-9">
                    ...
                    <figcaption class="mt-6 flex gap-x-4">
                        <img class="h-6 w-6 flex-none rounded-full bg-gray-50"
                            ...
                            alt="" />
                        <div class="text-sm leading-6"><strong class="font-semibold text-white font-share">Maria Hill</strong> –
        ...
        <div class="mt-16 max-w-2xl">
            <h2 class="text-2xl font-bold tracking-tight text-white font-share">Everything you need to get up and running</h2>
