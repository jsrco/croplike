<template>
    <div v-if="showInfo && !smolScreen()"
        class="z-30 absolute bottom-0 left-0 h-screen w-screen text text-white bg-dirt pt-8 px-4 overflow-y-scroll">
        <h1 class="pb-4">
    ...
    <div v-if="smolScreen()"
        class="z-30 absolute top-0 left-0 h-screen w-screen text text-white bg-dirt pt-8 px-4">
            Welcome to Croplike. A project by <a class="text-red-400 font-bold" href="https://www.fatthunder.com"
