    ...
    <div v-if="showInfo"
        ...
        <h1 class="pb-4">
            ...
            The demo allows the player to <span class="font-bold">move</span> around an arena. Movement consist of <span
                ...
                class="font-bold">wall jumping</span>.<br>
            ...
            return to normal size once the player jumps off.<br>
            The demo is at a very basic state. With geometry representing the arena and entities.<br>
            You can move with the <span class="font-bold text-yellow-400">left</span> and <span
                class="font-bold text-yellow-400">right arrow keys</span> or by <span
                class="font-bold text-yellow-400">touching / clicking</span> on either half of the screen.<br>
            ...
            The player can jump by hitting the <span class="font-bold text-yellow-400">up arrow</span> or <span
                class="font-bold text-yellow-400">touching / clicking</span> the <span
                class="font-bold text-yellow-400">jump icon ^</span> in the lower right.<br>
            ...
            the same features, one can hit <span class="font-bold text-yellow-400">p</span>,
        ...
        <p class="text-green-400 font-bold text-xl fixed bottom-0 pb-4 bg-dirt w-full" @click="startGame()">Click or touch
            here to start the demo!</p>
    </div>
</template>
