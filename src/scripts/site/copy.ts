export const Copy = {
    About: {
        ...
        textSix: `I've got stories itching to burst forth. And now, the power to weave the very worlds they dance in. Now, here's the kicker – this grand project might never see the finish line. Why, you ask? Oh, you know, a sprinkle of existential dread and a dash of limited free time. But who can resist an opportunity to take a wild swing at something? Especially if it is extraordinary and they enjoy doing it. Certainly not me, the over-caffeinated, semi-sane, and slightly sleep-deprived developer. Croplike is where coding meets chaos. With stories unfolding in the wee hours between parenting and debugging.`,
    },
    Landing: {
        Content: {
            textOne: 'Croplike is a distinctive farming and adventure game. Set in the captivating sci-fi fantasy setting of South Story. In this journey, players grapple with the theme of letting go. As they explore the world while managing a massive farming mech.',
            textTwo: 'The mech serves as a dynamic hub, which moves through turn-based gameplay. Providing players with the ability to manage resources harvested from the environment. Players can transform, craft, and plant these resources. Changing them into equipment, potions, and seeds. Further enhancing the game experience.',
            textThree: 'The game introduces a captivating dimension with the hunt for resources. Offering 2D action-focused platforming. During these hunts, players encounter massive lifeforms, utilizing crafted items for survival.',
            textFour: 'Croplike plans to deliver an immersive experience. Combining storytelling, farming mechanics, and rogue-like gameplay elements. Navigating a delicate balance between overcoming obstacles and the concept of letting go. Creating an engaging and thought-provoking adventure.',
        ...
        Faq: {
            questions: [
                {
                    id: 1,
                    question: "What is the significance of South Story?",
                    answer:
                        "South Story is a crafted setting designed for game development and storytelling. All narratives share a common element. A mysterious area where everything ceases to exist. The concept of non-existence can be a unsettling and intriguing aspect to explore.",
                },
                {
                    id: 2,
                ...
                },
                {
                    ...
                    answer:
                        "Croplike has been in development for years. The journey has been transformative. I've taught myself to code. Navigating through various  life changes has taught invaluable lessons.",
                },
                {
                    id: 4,
                    question: "When is Croplike going to release?",
                    answer:
                        "Croplike will release when its done. I am a solo developer working full time on another project while raising a small child. Delivering a quality, polished, and engaging game experience takes time. Years.",
                },
                {
                    id: 5,
                    question: "What will it cost?",
                    answer:
                        "Croplike is intended to be free. Everyone should have access to enjoyable games. Minimizing barriers to entry is a priority.",
                },
                {
                    id: 6,
