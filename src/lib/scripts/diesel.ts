    ...
    tick(timeStamp: number): void {
        ...
        if (this.timer > this.interval) {
            if (this.locked) {
                 ...
                 * Demo draw
                 */
                this.drawFrame("#", { x: 10, y: 10 }, 15)
                this.drawFrame("sThick", { x: 10, y: 25 }, 15)
                this.drawFrame("oLower", { x: 10, y: 40 }, 15)
                this.drawFrame("rFull", { x: 10, y: 55 }, 15)
                this.drawFrame("#", { x: 10, y: 70 }, 15)
                this.drawFrame("skull", { x: 10, y: 100 }, 15)
                this.drawFrame("#", { x: 25, y: 10 }, 15)
                this.drawFrame("uFull", { x: 25, y: 25 }, 15)
                this.drawFrame("fFancy", { x: 25, y: 40 }, 15)
                this.drawFrame("aThick", { x: 25, y: 55 }, 15)
                this.drawFrame("#", { x: 25, y: 70 }, 15)
                this.drawFrame("#", { x: 40, y: 10 }, 15)
                this.drawFrame("mLower", { x: 40, y: 25 }, 15)
                this.drawFrame(".", { x: 40, y: 40 }, 15)
                this.drawFrame("gFull", { x: 40, y: 55 }, 15)
                this.drawFrame("#", { x: 40, y: 70 }, 15)
                this.drawFrame("#", { x: 55, y: 10 }, 15)
                this.drawFrame("mUpper", { x: 55, y: 25 }, 15)
                this.drawFrame(".", { x: 55, y: 40 }, 15)
                this.drawFrame("eLower", { x: 55, y: 55 }, 15)
                this.drawFrame("#", { x: 55, y: 70 }, 15)

                this.drawFrame("#", { x: 70, y: 10 }, 15)
                this.drawFrame("eFull", { x: 70, y: 25 }, 15)
                this.drawFrame(".", { x: 70, y: 40 }, 15)
                this.drawFrame(".", { x: 70, y: 55 }, 15)
                this.drawFrame("#", { x: 70, y: 70 }, 15)

                this.drawFrame("#", { x: 85, y: 10 }, 15)
                this.drawFrame("rFancy", { x: 85, y: 25 }, 15)
                ...
                this.drawFrame("shield", { x: 100, y: 55 }, 15)
                ...
                this.drawFrame("sword", { x: 130, y: 55 }, 15)
